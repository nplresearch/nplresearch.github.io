<script>
  ...
  import { Home, Github, ArrowLeft, Twitter, Mail, Linkedin, BookOpen, Hash, Instagram } from "lucide-svelte"; // Import additional icons from lucide-svelte
...
<div class="splash">
  ...
  <!-- Button container for social links, icons only -->
